<header id="header" style="text-align: center; margin-top: 2.5rem; width: 100%">
...
<main>
    <section>
     ...
     <hr />
    <section>
        <h2 style="">Technologies and Tools</h2>
        <div style="display: flex; margin-left: 1rem; align-items: center; margin-top: -2rem;">
            ...
            <div style="margin-left: 1rem">
                <img src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/rails/rails-plain-wordmark.svg' alt="rails" height="100" width="45" />
            </div>
            <div style="margin-left: 1rem">
